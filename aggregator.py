...
class NMPAggregator:
    ...
    def __init__(self, **kwargs):
        ...
        # If setup prior using scalar value
        self.scalar_prior: bool = kwargs["scalar_prior"]
    ...
    def generate_prior(self, mean: float, cov: float) \
        ...
        Returns: tensors of prior's mean and prior's covariance
        """
    ...
    def aggregate(self,
                  lat_obs: torch.Tensor = None,
                  var_lat_obs: torch.Tensor = None):
        """
    ...
    def get_agg_state(self,
                      index: int = None) -> (torch.Tensor, torch.Tensor):
        """
    ...
    # End of class NMPAggregator


class CNMPAggregator:
    """A mean aggregator"""

    def __init__(self, **kwargs):
        """
        CNMP aggregator constructor
        Args:
            **kwargs: aggregator configuration
        """
        # Aggregator dimension
    ...
    # End of class CNMPAggregator


def get_aggregator_dict():
    return {"NMPAggregator": NMPAggregator,
            "CNMPAggregator": CNMPAggregator}